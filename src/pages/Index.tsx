            ...
            <CardContent className="p-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <p className="text-muted-foreground">
                    Я выделю время, чтобы провести совместный аудит ваших существующих рекламных кампаний на предмет релевантности. Аудит фида на предмет информативности названий товаров, описаний, и т. д. Чтобы изучить именно ваши навыки, идеи и опыт.
                  </p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-muted-foreground">
                    Затем мы вместе определим ваши цели, необходимые инструменты для их достижения.
                  </p>
                </div>

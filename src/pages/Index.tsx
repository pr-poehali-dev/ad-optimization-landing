            ...
            <Card className="border-2 border-accent/20 hover:border-accent/50 transition-all duration-300 shadow-lg">
              <CardContent className="p-8">
                ...
                <div className="space-y-4 text-muted-foreground">
                  ...
                  <p className="font-semibold text-foreground">
                    На скрине ниже пример такой связки. Отчет из «мастера отчетов» директ. Первая колонка - запрос, который вводили пользователи, вторая колонка - заголовок показанного объявления, третья колонка - ссылка на товар из показанного объявления.
                  </p>

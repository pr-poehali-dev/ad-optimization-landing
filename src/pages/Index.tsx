...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-muted/30 overflow-x-hidden w-full max-w-[100vw]">
            ...
            <Card className="border-2 border-accent/20 hover:border-accent/50 transition-all duration-300 shadow-lg">
              <CardContent className="p-8">
                ...
                <div className="space-y-4 text-muted-foreground">
                  ...
                  <p className="font-semibold text-foreground">
                    На скрине ниже пример такой связки. Отчет из «мастера отчетов» директ. Первая колонка - запрос, который вводили пользователи, вторая колонка - заголовок показанного под этот запрос объявления, третья колонка - ссылка на товар из этого объявления.
                  </p>
                ...
                <div className="mt-6 p-6 bg-accent/10 rounded-lg border-2 border-accent/20">
                  <p className="text-lg font-semibold text-primary text-center mb-4">
                    Проработайте этот момент, и посетители будут чаще добавлять товары в корзину, а число заказов возрастет, ведь вы будете предлагать именно то, что они ищут, а это напрямую влияет на количество денег в кассе.
                  </p>
                  <div className="flex justify-center">
                    <Button 
                      size="lg"
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-center text-muted-foreground mb-12 text-lg max-w-3xl mx-auto">
            Вот как отражается на статистике тот самый комплексный подход, где под каждый конкретный запрос показывается объявление с релевантным товаром: ссылкой, названием, описанием, ценой, изображением.
          </p>
            ...
            <CardContent className="p-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <p className="text-muted-foreground">
                    Я выделю время, чтобы провести совместный аудит ваших существующих рекламных кампаний на предмет релевантности. Аудит фида на предмет информативности названий товаров, описаний, и т. д.
                  </p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-muted-foreground">
                    Изучу именно ваши навыки, идеи и опыт. Вместе определим ваши цели, необходимые инструменты для их достижения.
                  </p>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <p className="text-muted-foreground">
                    И только тогда придёт время приступать к работе. Потому, что, если кто-то пытается навязать вам свой подход, не потратив времени на изучение вашего бизнеса, то он просто наивный глупец.
                  </p>
                </div>
